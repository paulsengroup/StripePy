...
def render_hidden():
    return html.Div(
        [
            ...
            html.P("", id="last-used-gen-belt"),
            html.P("", id="last-used-max-width"),
            html.P("", id="last-used-glob-pers-min"),
            html.P("", id="last-used-constrain-heights"),
            html.P("", id="last-used-k"),
            html.P("", id="last-used-loc-pers-min"),
            html.P("", id="last-used-loc-trend-min"),
            html.P("", id="last-used-nproc"),
